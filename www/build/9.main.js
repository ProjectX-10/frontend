...
var SecretKeyPage = (function () {
    ...
    SecretKeyPage.prototype.ngOnInit = function () {
        ...
        this.storage.get('user').then(function (value) {
            var user = value.item;
            _this.userInfo.userId = user.id;
            if (user.secretKey !== undefined && user.secretKey !== null) {
                _this.hasKey = true;
                _this.SECERET_KEY = user.secretKey;
            }
        });
