...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_api_DefaultApi__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_crypto_js_crypto_js__ = __webpack_require__(205);
...
var SecretKeyPage = (function () {
    function SecretKeyPage(navCtrl, navParams, alertCtrl, formBuilder, api, loadingCtrl) {
    ...
    SecretKeyPage.prototype.ngOnInit = function () {
        ...
        debugger;
        var ciphertext = __WEBPACK_IMPORTED_MODULE_4_crypto_js_crypto_js__["AES"].encrypt('pwd111', this.SECERET_KEY);
        console.log(ciphertext.toString());
        var bytes = __WEBPACK_IMPORTED_MODULE_4_crypto_js_crypto_js__["AES"].decrypt(ciphertext.toString(), this.SECERET_KEY);
        var plaintext = bytes.toString(__WEBPACK_IMPORTED_MODULE_4_crypto_js_crypto_js__["enc"].Utf8);
        console.log(plaintext);
        var shaString = __WEBPACK_IMPORTED_MODULE_5_crypto_js_sha256__(ciphertext.toString());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__secret_key__ = __webpack_require__(204);
...
SecretKeyPageModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__secret_key__["a" /* SecretKeyPage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__secret_key__["a" /* SecretKeyPage */]
        ]
