...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__secret_key__ = __webpack_require__(415);
...
var SecretKeyPageModule = (function () {
    function SecretKeyPageModule() {
    }
    SecretKeyPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__secret_key__["a" /* SecretKeyPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__secret_key__["a" /* SecretKeyPage */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__secret_key__["a" /* SecretKeyPage */]
            ]
    ...
    return SecretKeyPageModule;
}());

//# sourceMappingURL=secret-key.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__constants_app_constants__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_crypto_js_sha256__ = __webpack_require__(416);
 ...
 */
var SecretKeyPage = (function () {
    function SecretKeyPage(navCtrl, navParams, alertCtrl, formBuilder, api, loadingCtrl, storage) {
        ...
        this.hasKey = false;
        this.loginUser = {};
        this.userInfo = { secretKey: '', userId: '', passcode: '' };
        this.SECERET_KEY = '';
    }
    SecretKeyPage.prototype.ngOnInit = function () {
        var _this = this;
        this.storage.get('user').then(function (value) {
            _this.loginUser = value;
            _this.userInfo.userId = _this.loginUser.item.id;
        ...
        this.myForm = this.formBuilder.group({
            'secretKey': ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required]]
        });
    };
    ...
    SecretKeyPage.prototype.setupSecretkey = function () {
        var _this = this;
        var request = {};
        ...
        this.api.usersUpdatesecretkeyPost(request).subscribe(function (response) {
            _this.updateStorage();
    ...
    SecretKeyPage.prototype.updateStorage = function () {
        this.loginUser.item.secretKey = this.userInfo.secretKey;
        this.loginUser.item.status = __WEBPACK_IMPORTED_MODULE_5__constants_app_constants__["a" /* AppConstants */].KEY_STATUS;
    ...
    SecretKeyPage.prototype.isValid = function (field) {
        var formField = this.myForm.controls[field];
        if (formField !== undefined) {
            return formField.valid || formField.pristine;
        }
    };
    SecretKeyPage.prototype.secretKeyValidator = function (control) {
        if (control.value !== '') {
            return { invalidSecretKey: true };
        }
    };
    SecretKeyPage.prototype.showLoading = function () {
    ...
    SecretKeyPage.prototype.showError = function (text) {
    ...
    SecretKeyPage.prototype.getErrorMessage = function (text) {
        try {
...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(417));
	}
