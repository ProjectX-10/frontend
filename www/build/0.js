...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__secret_key__ = __webpack_require__(308);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_crypto_js_sha256__ = __webpack_require__(309);
...
var SecretKeyPage = (function () {
    function SecretKeyPage(navCtrl, navParams, alertCtrl, formBuilder, api, loadingCtrl, storage) {
        ...
        this.hasKey = false;
        this.loginUser = {};
        this.userInfo = { secretKey: 'phu12345', userId: '', passcode: '' };
    }
    SecretKeyPage.prototype.ngOnInit = function () {
        ...
        this.myForm = this.formBuilder.group({
            'secretKey': ['', [__WEBPACK_IMPORTED_MODULE_2__angular_forms__["f" /* Validators */].required, this.secretKeyValidator.bind(this)]]
        });
    };
    ...
    SecretKeyPage.prototype.setupSecretkey = function () {
        ...
        var shaString = __WEBPACK_IMPORTED_MODULE_5_crypto_js_sha256__(this.userInfo.secretKey.toString());
...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(310));
	}
