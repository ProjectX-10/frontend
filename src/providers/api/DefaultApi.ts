...
export class DefaultApi {
    protected basePath = 'https://yrfyxhlgqa.execute-api.us-east-1.amazonaws.com/dev';
     ...
     * 
     */
    public usersPutpointOptions(extraHttpRequestParams?: any): Observable<{}> {
        return this.usersPutpointOptionsWithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * 
     * 
     * @param putUserPointRequest 
     */
    public usersPutpointPost(putUserPointRequest: models.PutUserPointRequest, extraHttpRequestParams?: any): Observable<models.InlineResponse200> {
        return this.usersPutpointPostWithHttpInfo(putUserPointRequest, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * 
     */
    public usersQueryradiusOptions(extraHttpRequestParams?: any): Observable<{}> {
        return this.usersQueryradiusOptionsWithHttpInfo(extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     */
    public usersQueryradiusPost(queryRadiusRequest: models.QueryRadiusRequest, extraHttpRequestParams?: any): Observable<models.InlineResponse2003> {
        return this.usersQueryradiusPostWithHttpInfo(queryRadiusRequest, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
    ...
    public logoutPostWithHttpInfo(logoutRequest: models.LogoutRequest, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // authentication (fmAuthorizer) required
     ...
     * 
     */
    public usersPutpointOptionsWithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/putpoint`;
     ...
     * @param putUserPointRequest 
     */
    public usersPutpointPostWithHttpInfo(putUserPointRequest: models.PutUserPointRequest, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/putpoint`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        // verify required parameter 'putUserPointRequest' is not null or undefined
        if (putUserPointRequest === null || putUserPointRequest === undefined) {
            throw new Error('Required parameter putUserPointRequest was null or undefined when calling usersPutpointPost.');
        }
        // to determine the Content-Type header
        let consumes: string[] = [
            'application/json'
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            method: RequestMethod.Post,
            headers: headers,
            body: putUserPointRequest == null ? '' : JSON.stringify(putUserPointRequest), // https://github.com/angular/angular/issues/10612
            search: queryParameters
        });
     ...
     * 
     */
    public usersQueryradiusOptionsWithHttpInfo(extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/queryradius`;
     ...
     * @param queryRadiusRequest 
     */
    public usersQueryradiusPostWithHttpInfo(queryRadiusRequest: models.QueryRadiusRequest, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/users/queryradius`;

        let queryParameters = new URLSearchParams();
        let headers = new Headers(this.defaultHeaders.toJSON()); // https://github.com/angular/angular/issues/6845
        // verify required parameter 'queryRadiusRequest' is not null or undefined
        if (queryRadiusRequest === null || queryRadiusRequest === undefined) {
            throw new Error('Required parameter queryRadiusRequest was null or undefined when calling usersQueryradiusPost.');
        }
        // to determine the Content-Type header
        let consumes: string[] = [
            'application/json'
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            method: RequestMethod.Post,
            headers: headers,
            body: queryRadiusRequest == null ? '' : JSON.stringify(queryRadiusRequest), // https://github.com/angular/angular/issues/10612
            search: queryParameters
        });
